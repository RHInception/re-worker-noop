...
RPMSPEC := $(RPMSPECDIR)/re-worker-noop.spec
...
clean:
	...
	@rm -fR build dist rpm-build MANIFEST htmlcov .coverage $(SHORTNAME).egg-info reworkernoop.egg-info
	@rm -rf $(NAME)env
